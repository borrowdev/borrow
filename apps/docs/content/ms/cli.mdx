...
On the **free plan**, results are limited to the `us-east-1` and `eu-west-1` AWS regions. The **paid plan** returns results for all available regions worldwide. Visit the [pricing page](https://borrow.dev/pricing) to learn more about the limits and available plans.
