...
<Tabs items={["npm", "pnpm", "yarn", "bun"]} defaultValue="npm">
  <Tabs.Tab value="npm">```bash copy npm install @borrowdev/node ```</Tabs.Tab>
  <Tabs.Tab value="pnpm">```bash copy pnpm add @borrowdev/node ```</Tabs.Tab>
  <Tabs.Tab value="yarn">```bash copy yarn add @borrowdev/node ```</Tabs.Tab>
  <Tabs.Tab value="bun">```bash copy bun add @borrowdev/node ```</Tabs.Tab>
</Tabs>
